...
//            set_class (summary_container, Granite.StyleClass.CONTENT_VIEW);
            ...
            //Granite.Widgets.Utils.set_theming (summary_title, STYLE_CLASS_OVERVIEW_TITLE,
            //                                   "overview-title", Gtk.STYLE_PROVIDER_PRIORITY_APPLICATION);
            ...
            //Granite.Widgets.Utils.set_theming (inflow_label, STYLE_CLASS_OVERVIEW,
        ...
        private void budget_changed () {
            ...
            inflow_value_label.label = Envelope.Util.String.format_currency (
                                           budget_state.inflow);
            outflow_value_label.label = Envelope.Util.String.format_currency (
                                            budget_state.outflow);
