...
public class Envelope.App : Granite.Application {
    ...
    construct {
        ...
        app_copyright = "2014";
        application_id = "org.nlaplante.envelope";
        app_icon = "multimedia-audio-player";
        app_launcher = "envelope.desktop";
        app_years = "2014";

        main_url = "https://launchpad.net/envelope";
        bug_url = "https://bugs.launchpad.net/envelope/+filebug";
        help_url = "http://elementaryos.org/answers/+/envelope/all/newest";
        translate_url = "https://translations.launchpad.net/envelope";

        about_authors = {"Nicolas Laplante <nicolas.laplante@gmail.com>", null};
